...
const ERRORS = {
    ...
    auth: 'The Tracker.gg API key is invalid. Regenerate it in the developer portal and update the host env.',
    forbidden: 'Tracker.gg blocked the request. The app/key may not be approved for the API yet, or the endpoint is Cloudflare-gated for server access.',
