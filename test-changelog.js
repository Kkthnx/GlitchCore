...
const { fetchAndPostChangelogs } = require('./src/utils/changelogChecker.js');
...
client.once('ready', async () => {
    ...
    if (botState && botState.postedChangelogs.length > 0) {
        botState.postedChangelogs.pop();
        await botState.save();
    }

    console.log('Running changelog checker...');
    await fetchAndPostChangelogs(client);
